...
typedef struct clipbird_ble_advertiser clipbird_ble_advertiser_t;

typedef enum clipbird_ble_advertiser_error_code {
	CLIPBIRD_BLE_ADVERTISER_INVALID_ARGUMENT = 0,
	CLIPBIRD_BLE_ADVERTISER_INTERNAL_ERROR = 1
} clipbird_ble_advertiser_error_code_t;
