...
class ClipbirdServerHandshakeProtocol<T: PairedDevice>(
  ...
  suspend fun handshake(channel: Channel): T {
    ...
    val remoteDevice = pairedDeviceService.findById(remoteDeviceId) ?: throw PeerException(ErrorPacket.ErrorCode.DEVICE_NOT_PAIRED, "Device with id $remoteDeviceId is not paired")
